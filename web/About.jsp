    ...
    <ul class="collapsible" data-collapsible="accordion">
        <li>
          <div class="collapsible-header center">
            <br>
            <img src="materialize/img/diki.jpg" class="circle" width="150px" height="150px">
  ...
  <div class="col s4">
    <ul class="collapsible" data-collapsible="accordion">
        <li>
          <div class="collapsible-header center">
            <br>
            <img src="materialize/img/reva1.jpg" class="circle" width="150px" height="145px">
            <h5>Reva Ayu Sentikawati</h5>
          </div>
          <div class="collapsible-body">
            <p>Sebagai : Desain Interface & Reporting </p>
          </div>
        </li>
      </ul>
  </div>
