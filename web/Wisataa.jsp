    ...
    <ul class="slides">
      <li>
        ...
        <div class="caption center-align">
          <h3>Curug Sidomba</h3>
          <h5 class="light grey-text text-lighten-3">Curug Tersejuk</h5>
        </div>
      </li>
      <li>
        ...
        <div class="caption left-align">
          <h3>Curug Putri</h3>
          <h5 class="light grey-text text-lighten-3">Kecantikan Alam Alami</h5>
        </div>
      </li>
      <li>
        <img src="gambar/mountain.jpg"> <!-- random image -->
        <div class="caption right-align">
          <h3>Tirta Agung Mas</h3>
          <h5 class="light grey-text text-lighten-3">Berbagi Kebahagiaan</h5>
        </div>
      </li>
      <li>
        <img src="gambar/telagaremis.jpg"> <!-- random image -->
        <div class="caption center-align">
          <h3>Telaga Gerimis</h3>
          <h5 class="light grey-text text-lighten-3">Asrinya Alam</h5>
        </div>
      </li>
    </ul>
  </div>
...
<!--<div class="row container">-->
 <div class="fb-comments" data-href="http://localhost:8080/J2ee-master/Wisataa.jsp" data-numposts="5" width="100%"></div>
<!-- Footer -->
...
<!-- Script -->
  ...
  <script src="materialize/js/komentar.js"></script>
  </html>