<%-- 
    Document   : AddWisata
    Created on : 04-Mar-2017, 13:35:52
    Author     : novan
--%>
...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="asset_admin/plugins/iCheck/flat/blue.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="asset_admin/plugins/morris/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="asset_admin/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="asset_admin/plugins/datepicker/datepicker3.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="asset_admin/plugins/daterangepicker/daterangepicker.css">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="asset_admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>Tiket</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
    ...
    <div class="row">
        <div class="col-md-10">
           <tr>
            ...
            <tr>
                <td>Deskripsi :</td>
                <td><textarea id="comment" rows="5"name="deskripsi"class="form-control"></textarea></td>
           </tr>  
            <tr>
                <td>Gambar </td>
...
<script src="asset_admin/plugins/morris/morris.min.js"></script>
<!-- Sparkline -->
<script src="asset_admin/plugins/sparkline/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="asset_admin/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="asset_admin/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="asset_admin/plugins/knob/jquery.knob.js"></script>
<!-- daterangepicker -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
<script src="asset_admin/plugins/daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="asset_admin/plugins/datepicker/bootstrap-datepicker.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="asset_admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
...
<script src="asset_admin/dist/js/pages/dashboard.js"></script>
